// Bangladesh's 64 districts, used as the checkout "City" list (spelled as the backend's shipping module
// seeds them, so the value can be sent back as the address `district`). No frontend location dataset existed.
